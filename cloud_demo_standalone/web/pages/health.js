...
export default function HealthPage() {
  ...
  const cards = [
    ['运行模式', health?.profile === 'pure_cloud_demo' ? '在线展示' : (health?.profile || '在线展示'), '在线展示模式，不暴露私有资产入口'],
  ...
  return (
    <SectionWrapper>
      <div className="custom-screen space-y-6">
        <PageHeader title="云端状态" desc="检查在线展示版的服务状态、额度、上传限制和完整系统能力边界。" />
        ...
        <div className="border rounded-lg p-5 bg-white">
          ...
          <p className="text-xs text-gray-500 mb-3">上方是访问者可读状态；下方保留原始 JSON，方便部署排查。</p>
