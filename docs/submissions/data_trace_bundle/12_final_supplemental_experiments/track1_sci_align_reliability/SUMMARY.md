...
| Task 5 | 训练可用性边界检查 | Sciverse split=785/139；Sciverse-trained 4B PPL 19.8→4.3；4B score delta=-0.0034 | `track1_training_utility_ablation.json` |
...
单项实验的复现命令见 `docs/submissions/shared/DATA-TRACE.md` #174–#181。
