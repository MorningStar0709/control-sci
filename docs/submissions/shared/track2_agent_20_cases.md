...
> **补充验收**：`benchmark/agent/agent_capabilities.json` 当前登记 `meta.total_intents=15`；`docs/submissions/data_trace_bundle/12_final_supplemental_experiments/track2_agent_reliability/` 记录 router robustness、failure injection、多源选择 A/B、资源 Pareto 与 hard-document stress；权威索引见 `docs/submissions/shared/DATA-TRACE.md` #169-173。
